//name 27_c.c
//author Susmita Roy
//Write a program to execute ls -Rl by the following system calls c.execle
...
//printf("\n\n");
//considers all paths in $PATH for command
//execlp("ls","ls","-l",NULL);
//printf("\n\n");

execle("/bin/ls","ls","-l","-a",NULL,arrForexecle);
...
/*
 ...
 total 288
drwxrwxr-x  3 susmita-roy susmita-roy  4096 Aug 31 11:55  .
drwxr-x--- 22 susmita-roy susmita-roy  4096 Aug 31 11:55  ..
...
-rw-rw-r--  1 susmita-roy susmita-roy  4378 Aug 31 11:52  27_a.c
-rw-r--r--  1 susmita-roy susmita-roy 16384 Aug 31 11:53  .27_a.c.swp
-rw-rw-r--  1 susmita-roy susmita-roy  4440 Aug 31 11:49  27_b.c
-rw-rw-r--  1 susmita-roy susmita-roy   310 Aug 31 11:55  27_c.c
...
-rwxrwxr-x  1 susmita-roy susmita-roy 16032 Aug 31 11:55  a.out
